	...
	<body>
		<head>
			...
			<ul id = "menu_horizontal" style="float:right;">
				<li> <a href="espace_annotateur.php" title="Menu déroulant ici ?"> Espace Annotateur</a> </li>
				<li> <a href="espace_validateur.php" title="Menu déroulant ici ?"> Espace Validateur</a> </li>
